...
local Window  = Library.CreateLib("Script Made By shadow", "Synapse")
...
local Section = Tab:NewSection("Made By s1gaz#5435")
local Section = Tab:NewSection("ADD ME ON DISCORD s1gaz#5435")
